...
@section('isihalaman')<br><br>
    ...
    <h3><center>Perpustakaan Politeknik Negeri Jakarta</center></h3>

    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalPinjamTambah" style="margin-left: 50px; margin-right:5%;"> 
