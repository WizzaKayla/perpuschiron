...
@section('isihalaman')<br><br>
    <h3><center>Daftar Petugas Perpustakaan Politeknik Negeri Jakarta</center></h3>
    
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalPetugasTambah" style="margin-left: 50px; margin-right:5%;"> 
    Tambah Data Petugas 
    </button>

    <p>
    <div class="table-container" style="margin-left: 50px; margin-right:5%;">
    ...
    <div style="margin-left: 30px; margin-right:5%; padding:20px;"> 
    <!--awal pagination-->
