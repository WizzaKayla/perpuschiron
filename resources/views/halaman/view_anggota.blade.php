...
@section('isihalaman')<br><br>
    <h3><center>Daftar Anggota Perpustakaan Politeknik Negeri Jakarta</center></h3>
    
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAnggotaTambah" style="margin-left: 50px; margin-right:5%;"> 
        Tambah Data anggota 
    </button>
